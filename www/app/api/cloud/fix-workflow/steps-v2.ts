/**
 * Steps for Workflow v2 - Simplified "Local-style" Architecture
 *
 * Key difference from v1: The agent has a `diagnose` tool that gives
 * real-time CLS feedback, just like the local `fix_my_app` experience.
 * This lets the agent iterate internally instead of external orchestration.
 */
