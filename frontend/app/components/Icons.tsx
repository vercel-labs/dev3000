...
export function Code2({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Sparkles({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Globe({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Database({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
