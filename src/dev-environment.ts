...
export function createPersistentLogFile(override?: string): string {
  // Honor an explicit override (from --log-file). The Logger ensures the
  // directory exists, but we create it here too so the file write below
  // doesn't fail when the path is brand new.
...
export class DevEnvironment {
  ...
  constructor(options: DevEnvironmentOptions) {
    ...
    // unless --screenshots-dir was supplied.
    const projectName = getProjectName()
